...
if (isset($_SESSION['user_idS'])) {
    header('location:'.base_url().'login/Clogin/index');
  }
  ?>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 m-right centrarTexto" >
        ...
        <p><b>809-969-7319</b><span class="badge"><img src="assets/iconos/wasa.png" width="30" alt=""></span></p>
      </div>
      <div class="col-md-4 centrarTexto" >
        <h4>our location</h4>
        <p><img src="assets/iconos/_ionicons_svg_md-pin.svg" width="30"> hiderabad,india</p>
      </div>
    </div>
  </div>
</div>
     ...
     <ul class="navbar-nav " style="margin-top: 20%;border: 2px solid red;border-radius: 20px 20px 20px 20px;background: lightblue;">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle " href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         <i class="fas fa-cart-plus" ><label><b>Carrito</b></label><img src="<?php echo base_url() ?>assets/iconos/_ionicons_svg_md-cart.svg" width="40px"><span class="badge badge-primary" id='con'>0</span></i>
        </a>
