  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand white" style="color: white;" href="#"><h3 class="ggs distM">GGS</h3></a>
                <?php 
                  ...
                  ?>
  <a href="<?php echo base_url() ?>Cproduct/adminU"> <img src="<?php echo base_url() ?>assets/iconos/_ionicons_svg_md-settings.svg" id="admin" style="border: 1px solid white;border-radius: 30px 30px 30px 30px;background: red;cursor: pointer;" width="60px"></a>
     <?php } ?>

    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a class="nav-link distM" style="color: white; " href="#">Home </a>
      </li>
      <li class="nav-item">
        <a class="nav-link distM" style="color: white; " href="<?php echo base_url() ?>">Products</a>
      </li>
       <li class="nav-item">
        <a class="nav-link distM" style="color: white;" href="#">Quienes Somos?</a>
      </li>
       <li class="nav-item">
        <a class="nav-link distM" style="color: white;" href="<?php echo base_url() ?>Cproduct/Contactos">Contacts</a>
      </li>
